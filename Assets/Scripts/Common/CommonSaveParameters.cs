namespace Common
{
    public static class CommonSaveParameters
    {
        ...
        public const string DiceVisibility = "DiceVisibility";
        public const string ToolsDirectionState = "ToolsDirectionToggleState";

        public const string Player1 = "player-1";
        public const string Player2 = "player-2";
        public const string MaxPoints = "_MaxPoints";
        ...
        public const string DeckIsNotVisible = "DeckIsNotVisible";
        public const string ToolsDirectionNormal = "ToolsDirectionNormal";
        public const string ToolsDirectionReverse = "ToolsDirectionReverse";
    }
}